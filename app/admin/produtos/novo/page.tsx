        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 disabled:bg-gray-50 disabled:text-gray-400"
                  >
                    <option value="">Selecionar...</option>
                    {subcategories.map((s) => (
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Preço Original (R$)
                  {discount_pct !== null && (
                    <span className="ml-2 text-red-500 font-semibold">-{discount_pct}%</span>
                  )}
                </label>
                <input
                  type="number"
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
            ...
            <div>
              ...
              {form.image_url && (
                <div className="mt-2">
                  <img src={form.image_url} alt="Preview" className="h-24 object-contain rounded border border-gray-200" />
                </div>
              )}
            </div>
              ...
              <label key={key} className="flex items-center justify-between cursor-pointer">
                ...
                <div
                  ...
                  className={`relative w-11 h-6 rounded-full transition-colors cursor-pointer ${
                    form[key as keyof typeof form] ? 'bg-orange-500' : 'bg-gray-300'
                  }`}
                >
                  <span
          ...
          <div className="flex gap-3 justify-end">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-5 py-2.5 bg-orange-500 hover:bg-orange-600 disabled:opacity-60 text-white font-medium rounded-lg text-sm transition-colors"
            >
